...
class MockAIProvider(BaseAIProvider):
    ...
    async def triage(self, message: str) -> Dict[str, Any]:
        ...
        # Deterministic triage heuristic for testing
        if any(k in msg_lower for k in ("chest pain", "heart", "cardiac", "stroke", "unconscious")):
            return {
        ...
        elif any(k in msg_lower for k in ("bleed", "fracture", "accident", "trauma", "bone")):
            return {
                "symptoms": ["severe pain", "suspected fracture / bleeding"],
                "urgency": "high",
                "urgency_score": 0.75,
                "specialty": "Trauma",
            }
            ...
            return {
                "symptoms": ["general distress", "mild symptoms"],
                "urgency": "moderate",
                "urgency_score": 0.35,
